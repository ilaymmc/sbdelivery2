...
fun DemoFeature.State.reduce(msg: DemoFeature.Msg):
    Pair<DemoFeature.State, Set<DemoFeature.Eff>> = when(msg) {
    is DemoFeature.Msg.Clear -> copy(count = 0, isLoading = false) to setOf(DemoFeature.Eff.StopGenerate)
